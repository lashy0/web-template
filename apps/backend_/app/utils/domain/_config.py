...
class DomainPluginConfig:
    ...
    controller_submodules: list[str] = field(
    ...
    signal_submodules: list[str] = field(
        default_factory=lambda: [
            "signals",
            "events",
            "listeners",
    ...
    schema_submodules: list[str] = field(
        default_factory=lambda: [
            "schemas",
            "models",
            "dtos",
    ...
    service_submodules: list[str] = field(
        default_factory=lambda: [
            "services",
        ]
    )
    repository_submodules: list[str] = field(
        default_factory=lambda: [
            "repositories",
            "repos",
        ]
