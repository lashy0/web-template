...
async def fx_client(app: Litestar) -> AsyncGenerator[AsyncTestClient]:
    """Test client for unit tests that exercise the application surface."""
    try:
