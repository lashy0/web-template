...
| `BACKEND_LORAWAN_CREDENTIALS_ENCRYPTION_KEY` | empty | Required for generating and reading persisted LoRaWAN credentials: URL-safe base64-encoded 32-byte AES-256-GCM key supplied by the deployment secret manager; keep it stable across restarts |
