...
def generate_credentials(
    ...
    raise CredentialsGenerationError(f"Unsupported activation type: {activation_type!r}")
...
def _generate_abp_credentials(
    ...
    raise CredentialsGenerationError(f"Unsupported LoRaWAN version: {lorawan_version!r}")
...
def _generate_otaa_credentials(
    ...
    if lorawan_version is LoRaWanVersion.V1_0:
        return Otaa10Credentials(dev_addr=dev_addr, app_key=app_key.hex())
