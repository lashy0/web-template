...
import { ArchiveDefectGroup } from '@/components/Defects/Groups/ArchiveDefectGroup'
...
import { RestoreDefectGroup } from '@/components/Defects/Groups/RestoreDefectGroup'
